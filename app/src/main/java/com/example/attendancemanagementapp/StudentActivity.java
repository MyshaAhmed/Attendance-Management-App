...
public class StudentActivity extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        int studentRollColumnIndex = cursor.getColumnIndex(DbHelper.STUDENT_ROLL_KEY);
        int subjectNameColumnIndex = cursor.getColumnIndex(DbHelper.STUDENT_NAME_KEY);

        Log.d("ColumnNames", "SID: " + DbHelper.S_ID);
        Log.d("ColumnNames", "Roll: " + DbHelper.CLASS_NAME_KEY);
        Log.d("ColumnNames", "SubjectName: " + DbHelper.STUDENT_NAME_KEY);

        while (cursor.moveToNext()){
            long sid = cursor.getLong(sidColumnIndex);
            int roll = cursor.getInt(studentRollColumnIndex);
            String name= cursor.getString(subjectNameColumnIndex);
    ...
    private void SetToolbar() {
        ...
        subtitle.setText(calendar.getDate()); //subtitle.setText(subjectName+" | "+calendar.getDate());
